...
Mise à jour du 30 août 2026 : **PASS du correctif frontend P1-B `91474c4f`, de la reprise versionnée, de la révocation CMA explicitement autorisée et du nettoyage intégral du sandbox ; PARTIAL de la recette P1-B globale.** Après révocation PAD : total392184 ; retrait commission : total388880 ; multi-lots et décision CMA orpheline : blocages attendus. Après révocation de l'orphelin : run9 réussi sans commission CMA, total508880 expliqué par les frais ONE distincts. La version historique est restée intacte jusqu'au nettoyage. Les deux fichiers et les 123 lignes DB du sandbox sont supprimés ; baselines64dossiers/162runs/9versions/45brouillons/5users/0décision retrouvées, 35 empreintes hors sandbox identiques. Tarifs et migration inchangés. 271 tests frontend et 837 tests Deno réussis (6 ignorés), sept gates locaux verts sur le code livré. **Restent à prouver en runtime : rejeu/concurrence du ledger et brouillon historique non envoyé.** Aucun nouveau PDF/brouillon/email, aucun patch applicatif pendant ce nettoyage. P1-C reste suspendu jusqu'au PASS runtime P1-B ; aucun GO de production générale.
