...
| PAD-NST-2E-C-D | UI opérateur — implémentation | **⏳ EN ATTENTE GO CTO séparé** | P2 | PAD-NST-2E-B-R3 | 2026-05-08 | Précondition R3 levée (2026-05-09). C-D-SPEC non invalidée. Addendum R1 non invalidé. | Implémentation Lovable uniquement après GO CTO séparé explicite. |
