-- MAP_7B_FUNCTION_SNAPSHOT_PRE
-- Captured: 2026-05-14
-- Source: pg_get_functiondef('public.propagate_classification_candidate_to_fact(uuid,text)'::regprocedure)
-- Purpose: Restore exactly this version if MAP-7B migration must be rolled back.
