-- MAP_8B_FUNCTION_SNAPSHOT_PRE
-- Captured live: 2026-05-14 via pg_get_functiondef
-- Purpose: Restore exactly this version if MAP-8B migration must be rolled back.
-- Assertion d'état MAP-7B passée :
--   * pad_category -> cargo.pad_category (regex ^[TPC][0-9]{2}$)
--   * hs10_uemoa   -> cargo.hs_code (scheme=hs10_uemoa, regex ^\d{10}$)
--   * pad_label    -> pad_label_forbidden
--   * cn8/hs6/nhm/nst2007/nstr -> candidate_kind_not_whitelisted (deferred_to MAPPING-TAX-CHAIN-0)
