  ...
  public: {
    Tables: {
      ...
      intake_fact_batches: {
        ...
        Relationships: [
          {
            foreignKeyName: "intake_fact_batches_case_id_fkey"
            columns: ["case_id"]
            isOneToOne: false
            referencedRelation: "quote_cases"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      quote_scenario_derive_open_points: {
        Args: { p_snapshot: Json }
        Returns: Json
      }
      quote_scenario_is_enum: {
        Args: { p_allowed: string[]; p_value: Json }
        Returns: boolean
      }
      quote_scenario_is_int: {
        Args: { p_max: number; p_min: number; p_value: Json }
        Returns: boolean
      }
      quote_scenario_is_ref: { Args: { p_value: Json }; Returns: boolean }
      quote_scenario_monetary_token: {
        Args: { p_key: string }
        Returns: boolean
      }
      quote_scenario_open_point: {
        Args: { p_code: string; p_ref: string }
        Returns: Json
      }
      quote_scenario_place_violation: {
      ...
      quote_scenario_snapshot_violation: {
