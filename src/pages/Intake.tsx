          ...
          <CardContent className="pt-6 space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-sm text-gray-600">Niveau de complexité</div>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-lg">
              ...
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-sm text-gray-600">Champs manquants</div>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                  ...
                  {result.missing_fields.map((field, i) => (
                    <li key={i} className="flex items-start gap-2 p-3 bg-orange-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500">Champ: {field.field}</div>
                      </div>
                    </li>
                  ))}
                </ul>
