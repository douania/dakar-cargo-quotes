-- PAD-NST-2E-B-R3 — Migration corrective de ré-alignement
-- Date : 2026-05-08
-- Statut : R3 — ré-application suite à dérive DB post-R2
...
-- Méthode : copie conforme du body SQL R2 — AUCUNE MODIFICATION MANUELLE
-- Le body ci-dessous est identique octet-à-octet au fichier source (hors cet en-tête).
-- Règles : 88 (TIER-A/B uniquement, action NOT IN defer/remove)
-- Périmètre : data-only — DELETE + INSERT depuis table temporaire expected_rules
-- Contrôles intégrés : 5 sur expected_rules + 6 sur table finale + 2 EXCEPT bidirectionnels
